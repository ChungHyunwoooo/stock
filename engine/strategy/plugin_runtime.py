...
from engine.notifications import DiscordWebhookNotifier, MemoryNotifier
from engine.core import JsonRuntimeStore
from engine.strategy.plugin_registry import PluginRegistry
...
runtime_store_plugins.register(
    "json",
    lambda state_path="state/runtime_state.json", **_: JsonRuntimeStore(Path(state_path)),
