...
- [ ] **LIFE-01**: 전략 상태가 draft→testing→paper→active→archived 순서로만 전이되며, 규칙 위반 전이를 차단한다
...
- [ ] **LIFE-04**: 논문/커뮤니티의 레퍼런스 전략을 JSON StrategyDefinition으로 변환하는 구조화된 워크플로우가 있다
...
- [ ] **RISK-03**: 신규 진입 시 기존 활성 전략과의 신호 상관관계가 0.7 초과이면 진입을 차단한다
